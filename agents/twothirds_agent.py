...
class Twothirds_Agent(Agent):
	def __init__(self, num, memlimit, initnamesdist, poprule, updaterule, offset=0):
		...
		EXCEPTION_THRESHOLD = (self.MEM_SIZE*(1/3)) # we want the most frequent item to be at least 2/3rds so exceptions can't exceed 1/3rd
